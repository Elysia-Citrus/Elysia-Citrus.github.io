...
export const siteConfig: SiteConfig = {
	title: "主页",
	subtitle: "白纸春天的秘密基地",
	siteURL: "https://Elysia-Citrus.github.io/", // 请替换为你的站点URL，以斜杠结尾
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/image-1.png",
				"/assets/desktop-banner/image-2.png",
				"/assets/desktop-banner/image-3.png",
		...
		position: "50% 20%", // 等同于 object-position，仅支持 'top', 'center', 'bottom'。默认为 'center',事实上可以自己修改一部分比例
...
export const fullscreenWallpaperConfig: FullscreenWallpaperConfig = {
	src: {
		desktop: [
			...
			"/assets/desktop-banner/image-2.png",
			"/assets/desktop-banner/image-3.png",
			// "/assets/desktop-banner/image-4.png",
			// "/assets/desktop-banner/image-5.png",
			// "/assets/desktop-banner/image-6.png",
		], // 桌面横幅图片
		mobile: [
			"/assets/mobile-banner/1.webp",
			"/assets/mobile-banner/2.webp",
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Elysia-Citrus",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/492437824",
					external: true,
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "欢迎来到我的博客 (*≧▽≦) 祝你今天也平安顺遂.", // 公告内容
